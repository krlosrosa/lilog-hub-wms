...
import type { CompanyCode, DemandTagVariant } from '../types/devolucao.schema';
  ...
  return (
    <article
      className={cn(
        ...
        cargaSegregada &&
          !isPriority &&
          'border-l-[3px] border-l-error bg-error/[0.03]',
        className
      )}
      {...props}
    >
      ...
      <div className="min-w-0 flex-1 space-y-0.5">
        ...
        <div className="flex min-w-0 items-center justify-between gap-2 pt-0.5">
          <div className="flex min-w-0 items-center gap-1">
            ...
            {cargaSegregada && (
              <span className="inline-flex shrink-0 items-center gap-0.5 rounded-full bg-error-container px-1.5 py-px text-[10px] font-medium leading-none text-on-error-container">
