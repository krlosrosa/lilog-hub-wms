  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          'relative flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-outline-variant text-on-surface-variant transition-colors touch-manipulation active:scale-95 hover:border-warning hover:bg-warning-container/20 hover:text-warning',
