...
import { PaleteV2Toolbar, type PaleteSheetIntent } from '@/features/recebimento-v2/components/palete-v2-toolbar';
import {
  getActivePaleteCodigo,
  PALETE_OBRIGATORIO_MSG,
  setActivePaleteV2,
} from '@/features/recebimento-v2/services/palete-session-v2.service';
...
import { useProductSearchQuery } from '@/features/recebimento-v2/hooks/use-product-search-v2';
import {
...
interface DetalheItemV3ViewProps {
  demandId: string;
  sku?: string;
}
...
export function DetalheItemV3View({ demandId, sku: rawSku }: DetalheItemV3ViewProps) {
  ...
  const { conferirItem, deletarConferencia, getConferenciasBySku } = useConferenciaV3(demandId);
