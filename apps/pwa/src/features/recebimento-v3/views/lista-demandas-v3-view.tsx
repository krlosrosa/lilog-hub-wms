...
import { ProcessStatusCardV3 } from '../components/process-status-card-v3';
import { useBootstrapV2 } from '@/features/recebimento-v2/hooks/use-bootstrap-v2';
import { useListaDemandasV2 } from '@/features/recebimento-v2/hooks/use-lista-demandas-v2';
...
export function ListaDemandasV3View() {
  const {
    processos,
    filteredProcessos,
    search,
