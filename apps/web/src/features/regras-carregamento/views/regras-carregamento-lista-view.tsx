...
import { Container, Plus, SearchX } from 'lucide-react';
...
const BASE_PATH = '/config-operacional/regras-carregamento';
...
export function RegrasCarregamentoListaView() {
  const {
    filtroAtivo,
    setFiltroAtivo,
    busca,
        ...
        <div className="mx-auto max-w-container">
          <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              ...
              <p className="mt-1 max-w-xl text-body-md text-muted-foreground">
                Defina quanto tempo cada operador deveria levar para carregar uma minuta na
                doca — paletes, clientes, tabelas e gordura de início/fim.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-5 md:gap-6">
            <RegrasProdutividadeStatsCards
              stats={stats}
              metaLabel="Meta de tempo por minuta"
            />
