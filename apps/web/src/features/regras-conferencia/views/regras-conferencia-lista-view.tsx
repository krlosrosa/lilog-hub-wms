...
const BASE_PATH = '/config-operacional/regras-conferencia';
...
export function RegrasConferenciaListaView() {
  const {
    filtroAtivo,
    setFiltroAtivo,
    busca,
          ...
          <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              ...
              <p className="mt-1 max-w-xl text-body-md text-muted-foreground">
                Defina quanto tempo cada conferente deveria levar para validar um mapa no
                staging — linhas conferidas, paletes, clientes e gordura de início/fim.
              </p>
            </div>
