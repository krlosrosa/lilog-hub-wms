...
import { useRegraConferenciaForm } from '@/features/regras-conferencia/hooks/use-regra-conferencia-form';

type RegraConferenciaFormViewProps = {
  regraId?: string;
};

export function RegraConferenciaFormView({ regraId }: RegraConferenciaFormViewProps) {
  const {
    form,
    isEditing,
    isLoading,
    ...
    simQtdClientes,
    setSimQtdClientes,
  } = useRegraConferenciaForm({ regraId });
        ...
        <main className="flex min-h-dvh items-center justify-center px-margin-mobile py-12 md:px-margin-desktop">
          <div className="text-center">
            ...
            <Button asChild variant="link" className="mt-2">
              <Link href={regrasProdutividadeListaPath('conferencia')}>Voltar à lista</Link>
            </Button>
          </div>
        </main>
      </SidebarMain>
        ...
        <div className="mx-auto max-w-container">
          <div className="mb-6">
            <Button
              ...
              asChild
            >
              <Link href={regrasProdutividadeListaPath('conferencia')}>
            ...
            <form onSubmit={onSubmit}>
              <div className="grid gap-5 lg:grid-cols-[1fr_320px] lg:items-start">
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <input
                          id="nome"
                          {...register('nome')}
                          placeholder="Ex.: Perfil Alfa Conferência"
                  ...
                  <CollapsiblePanelSection icon={Clock} title="Tempos de conferência">
                    <ParametrosConferenciaPanel
                      register={register}
                      errors={errors}
                      variant="conferencia"
                    />
                  ...
                  <CollapsiblePanelSection icon={Clock} title="Gordura do mapa">
                    <p className={cn(sectionLabelClassName, 'mb-3 normal-case tracking-normal')}>
                      Margem de segurança no início e fim da conferência no staging.
                    </p>
                    <ParametrosConferenciaPanel
                      register={register}
                      errors={errors}
                ...
                <div className="lg:sticky lg:top-6">
                  <TempoConferenciaPreview
                    params={watchedValues}
                    qtdLinhas={simQtdLinhas}
                    qtdPaletes={simQtdPaletes}
                    qtdClientes={simQtdClientes}
                    onQtdLinhasChange={setSimQtdLinhas}
