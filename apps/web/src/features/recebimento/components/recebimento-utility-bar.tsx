      ...
      <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center sm:justify-end lg:w-auto">
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <button
            type="button"
            onClick={onExportar}
            className="inline-flex h-8 shrink-0 items-center gap-1 rounded-lg border border-outline-variant bg-surface-highest px-2.5 text-[11px] font-medium text-foreground transition-colors hover:bg-surface-highest/80"
          >
