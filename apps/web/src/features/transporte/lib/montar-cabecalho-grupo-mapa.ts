...
import type { CabecalhoGrupoMapaApi, ItemGrupoMapaApi } from '@/features/transporte/lib/gerar-mapas-api';
import {
  calcularTotalPaletesFisicos,
  type ItemComBreakdownPalete,
} from '@/features/transporte/lib/calcular-breakdown-quantidade';
