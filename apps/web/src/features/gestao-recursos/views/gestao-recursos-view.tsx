...
function SectionCount({
  ...
  return (
    <span
      className={cn(
        'inline-flex min-w-[1.25rem] items-center justify-center rounded px-1.5 py-0.5 text-[10px] font-semibold tabular-nums',
        styles[variant],
      )}
    >
      {count}
...
export function GestaoRecursosView({
  ...
  const {
    ...
    confirmPausaAction,
  } = useGestaoRecursosProcesso(processo);
          ...
          <div className="mx-auto max-w-container space-y-3">
            <header className="flex flex-wrap items-end justify-between gap-3 border-b border-outline-variant pb-3">
              <div className="min-w-0">
                <nav className="mb-0.5 flex flex-wrap gap-1.5 text-caption text-muted-foreground">
                  ...
                  <span aria-hidden>/</span>
                  <span className="text-primary">{breadcrumbAtual}</span>
                </nav>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    aria-label="Buscar operador por nome, matrícula ou ID"
            ...
            {isLoading && canShowPainel ? (
              <div
                ...
                role="status"
                aria-label="Carregando recursos"
              >
                      ...
                      <table className={compactTableClassName}>
                        <thead>
                          <tr className={compactTableHeadRowClassName}>
                            <th
                              className={compactTableHeadCellClassName('w-7')}
                              scope="col"
                            />
                          ...
                          {atuandoOperators.length === 0 ? (
                            <tr>
                              <td
                                ...
                                colSpan={7}
                              >
                                Nenhum operador atuando no momento.
                              </td>
                            </tr>
                          ) : (
