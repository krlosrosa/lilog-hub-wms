...
import type { RegrasExpedicaoStats } from '@/features/regras-expedicao/types/regra-expedicao.schema';

type RegrasExpedicaoStatsCardsProps = {
  stats: RegrasExpedicaoStats;
};

export function RegrasExpedicaoStatsCards({ stats }: RegrasExpedicaoStatsCardsProps) {
  return (
