...
import { ArrowLeft, Loader2, PackageX, Plus, Save, Trash2 } from 'lucide-react';
...
import { useParametrosDevolucao } from '@/features/config-operacional/hooks/use-parametros-devolucao';
...
function CondicoesChecklistSection({ control }: { control: ReturnType<typeof useParametrosDevolucao>['form']['control'] }) {
...
export function ParametrosDevolucaoView() {
  const { form, isLoading, isSubmitting, onSubmit, unidadeSelecionada } =
    useParametrosDevolucao();
                ...
                <div className="rounded-xl border border-border bg-card p-4">
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                    ...
                    <li className="pt-2 text-xs">
                      Peso continua obrigatório apenas para produtos PVAR (peso variável)
                      no cadastro.
                    </li>
                  </ul>
                </div>
