-- Remove WMS schemas and decouple recebimento.unitizador_id from armazenagem.unitizadores.

ALTER TABLE "recebimento"."itens_recebimento" DROP CONSTRAINT IF EXISTS "itens_recebimento_unitizador_id_unitizadores_id_fk";
--> statement-breakpoint
ALTER TABLE "recebimento"."itens_recebimento" DROP CONSTRAINT IF EXISTS "itens_recebimento_unitizador_id_fkey";
--> statement-breakpoint
...
--> statement-breakpoint
DROP SCHEMA IF EXISTS "cobranca_transportadora" CASCADE;
--> statement-breakpoint
DROP SCHEMA IF EXISTS "corte_operacional" CASCADE;
--> statement-breakpoint
DROP SCHEMA IF EXISTS "devolucao" CASCADE;
--> statement-breakpoint
DROP SCHEMA IF EXISTS "estoque" CASCADE;
--> statement-breakpoint
DROP SCHEMA IF EXISTS "expedicao" CASCADE;
--> statement-breakpoint
DROP SCHEMA IF EXISTS "op_wms" CASCADE;
--> statement-breakpoint
