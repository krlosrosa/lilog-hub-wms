-- Read model for /recebimento/[id] detail page.
-- Aggregates pré-recebimento + recebimento + checklist + itens + divergências + avarias
-- in a single row to avoid N+1 API/DB round trips on the frontend.

CREATE OR REPLACE VIEW "recebimento"."vw_pre_recebimento_detalhe" AS
SELECT
