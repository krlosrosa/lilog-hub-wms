ALTER TABLE "expedicao"."transportes" ADD COLUMN "perfil_pagamento_id" uuid;--> statement-breakpoint
ALTER TABLE "expedicao"."transportes" ADD COLUMN "perfil_pagamento_nome" varchar(255);--> statement-breakpoint
