ALTER TABLE "expedicao"."transportes" ADD COLUMN "is_prioridade" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "expedicao"."transportes" ADD COLUMN "nivel_prioridade" "operacao_doca_prioridade_type";--> statement-breakpoint
