...
@ApiErrorResponses()
export class GetRecebimentoController {
  constructor(private readonly getRecebimentoUseCase: GetRecebimentoUseCase) {}

  @RequirePermissions(RECEBIMENTO_PERMISSION.VISUALIZAR)
  @Get(':id')
  @ApiOperation({
    summary: 'Get recebimento by id',
    operationId: 'getRecebimento',
  })
  @ApiSuccessResponse(RecebimentoResponseDto)
  handle(@Param('id') id: string) {
    return this.getRecebimentoUseCase.execute(id);
  }
}
