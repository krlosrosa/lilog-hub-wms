...
const migrationPath = resolve(
  __dirname,
  '../src/infra/db/providers/drizzle/config/migrations/0097_recebimento_avarias_lote.sql',
);
...
try {
  ...
  if (existing.length > 0) {
    console.log('Migration 0097 already applied');
    process.exit(0);
  }
  ...
  console.log('Migration 0097 applied successfully');
} catch (error) {
