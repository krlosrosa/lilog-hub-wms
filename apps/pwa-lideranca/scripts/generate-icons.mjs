...
// Leadership brand: #1a1a2e
const BRAND_COLOR = [26, 26, 46];
const SPLASH_BG = [248, 249, 255];

const png192 = createSquarePng(192, ...BRAND_COLOR);
const png512 = createSquarePng(512, ...BRAND_COLOR);
...
console.log('PWA Liderança icons and splash screens generated.');
