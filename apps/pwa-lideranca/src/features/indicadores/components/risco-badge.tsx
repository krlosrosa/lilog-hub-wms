...
import type { NivelRisco } from '@/features/indicadores/lib/torre-controle.schema';
import { NIVEL_RISCO_LABELS } from '@/features/indicadores/lib/torre-controle.schema';

const RISCO_STYLES: Record<NivelRisco, { chip: string; pulse?: boolean }> = {
  critico: {
